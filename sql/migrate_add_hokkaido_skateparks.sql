...
-- Never assume prefecture row id = 1 is Hokkaido (legacy DBs may have had a different insert order).
SET @hokkaido_id = (SELECT id FROM prefectures WHERE name = 'Hokkaido' LIMIT 1);
...
'Sapporo Dome Skateboard Area',
'札幌ドーム　スケートボードエリア',
@hokkaido_id, 'Sapporo', '1 Hitsujigaoka, Toyohira-ku, Sapporo, Hokkaido 062-0045',
...
'Kutchan Skateboard Park',
'倶知安スケートボードパーク',
@hokkaido_id, 'Kutchan', 'Kutchan Town, Abuta District, Hokkaido',
...
'Kushiro Street Sports Park',
'釧路ストリートスポーツパーク',
@hokkaido_id, 'Kushiro', '1 Minhamacho, Kushiro, Hokkaido',
...
@hokkaido_id, 'Nayoro', 'Nishin, Nayoro, Hokkaido',
...
'栗山駅南公園スケートボードパーク',
@hokkaido_id, 'Kuriyama', 'Central 3-chome, Kuriyama Town, Yubari District, Hokkaido',
...
'メムシ公園　スケートパーク',
@hokkaido_id, 'Chitose', '2120-7 Negoshi, Chitose, Hokkaido',
...
@hokkaido_id, 'Iwamizawa', 'Higashihoncho, Kurisawa-cho, Iwamizawa, Hokkaido',
...
'室蘭レインボー公園　スケートパーク',
@hokkaido_id, 'Muroran', '1-2-1 Kaigancho, Muroran, Hokkaido',
...
'MOAI SKATEPARK',
'MOAI SKATEPARK',
@hokkaido_id, 'Sapporo', 'Takino area, Minami-ku, Sapporo, Hokkaido',
...
'HOT BOWL',
'HOT BOWL',
@hokkaido_id, 'Sapporo', 'Shinkotoni, Kita-ku, Sapporo, Hokkaido',
...
'CRASS ACTION SPORTS HOUSE',
'CRASS ACTION SPORTS HOUSE',
@hokkaido_id, 'Sapporo', '1-6 Kita 10-jo Higashi 17-chome, Higashi-ku, Sapporo, Hokkaido 065-0010',
...
'LOWSTAR',
'LOWSTAR',
@hokkaido_id, 'Kutchan', '23-1 Kita 2-jo Nishi 2-chome, Kutchan Town, Abuta District, Hokkaido 044-0052',
...
'Diamond Ramp',
'ダイヤモンドランプ',
@hokkaido_id, 'Hokuto', 'Near Tomikawa IC, Hokuto, Hokkaido',
...
'SPRAY',
'SPRAY',
@hokkaido_id, 'Asahikawa', '1-1-8 Toyooka 12-jo 1-chome, Asahikawa, Hokkaido',
...
'BRAYZ SK8 DOME',
'BRAYZ SK8 DOME',
@hokkaido_id, 'Tomakomai', 'Ariake-cho, Tomakomai, Hokkaido',
...
'Nuggets',
'Nuggets',
@hokkaido_id, 'Sapporo', '104-8 Tokiwa 5-jo 2-chome, Minami-ku, Sapporo, Hokkaido',
